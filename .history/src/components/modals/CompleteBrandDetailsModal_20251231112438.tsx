...
import { staticBrands, updateBrand, type Brand } from "@/data/staticData";
...
export default function CompleteBrandDetailsModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Prepare update data matching Brand interface
      const updateData: Partial<Omit<Brand, "id" | "created_at" | "updated_at" | "categories">> = {
        name: formData.name,
      ...
      // Update brand with all data
      updateBrand(user.brand_id, updateData);
