...
export default function CompleteBrandDetailsModal({
  ...
  const uploadLogo = async (file: File, brandId: string): Promise<string> => {
    try {
      ...
      // If storage fails, we could fallback to a data URL or throw
      // For now, we'll throw to ensure data integrity
      throw error;
    }
  };
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <DialogDescription className="text-sm text-muted-foreground mt-1">
                Ajoutez les informations essentielles pour votre marque.
