...
import { Store, Package, Eye, Settings, Plus, Edit, ArrowRight, Globe, MapPin, Mail, Phone, Instagram, Facebook, BarChart3 } from "lucide-react";
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <Card className="glass">
                  <CardHeader>
                    ...
                    <CardDescription>Voir les statistiques et analyses détaillées</CardDescription>
                  </CardHeader>
                  <CardContent>
