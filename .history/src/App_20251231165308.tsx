...
import BrandOwnerAnalyticsDashboard from "./pages/brand-owner/BrandOwnerAnalyticsDashboard";
      ...
      <AuthModalProvider>
        <TooltipProvider>
          ...
          <BrowserRouter>
            ...
            <Route path="/brand-owner/analytics" element={<ProtectedRoute requireBrandOwner><BrandOwnerAnalyticsDashboard /></ProtectedRoute>} />
